...
| funding_source_updated | A funding source has been updated. This can also be fired as a result of a correction after a bank transfer processes or when a bank changing `type` from `Checking` to `Savings`. |
...
| customer_funding_source_updated | A Customer's funding source has been updated. This can also be fired as a result of a correction after a bank transfer processes or when a bank changing `type` from `Checking` to `Savings`. |
