...
This section covers how to initiate a transfer from a Dwolla [Account](#accounts) resource.
...
{  
   "_links":{  
      "charge-to":{  
         "href":"https://api-uat.dwolla.com/accounts/d795f696-2cac-4662-8f16-95f1db9bddd8"
      }
   },
   "amount":{  
      "value":"4.00",
